...
export default function Solutiones() {
  ...
  const sections = [
    ...
    },
    {
      ...
      color: "#ff6a00",
      gradient: "linear-gradient(100deg, #ff7a00, #ff4d00)",
      list: [
  ...
  // Animación barra de progreso automática
  useEffect(() => {
  ...
  // Observer para fade-in al hacer scroll
  useEffect(() => {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 font-titillium">
          {sections.map((section, index) => (
            ...
            >
              ...
              <h4 className="text-lg font-pt-sans-caption font-semibold mb-1">{section.brand}</h4>
              ...
              {activeIndex === index && (
                <div className="mt-2">
                  ...
                  <button
                    onClick={() => {
                      if (section.brand === "Lean Retail") navigate("/retail");
                      if (section.brand === "Lean Mobility") navigate("/mobility");
                      if (section.brand === "Lean Industry") navigate("/industry");
                    }}
          ...
          >
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 sm:gap-10 lg:gap-12">
              <div className="w-full md:w-1/2 text-white">
                ...
                >
                  <img src={sections[activeIndex].logo} alt={`${sections[activeIndex].brand} logo`} className="h-6 w-6 object-contain" />
                ...
                <div className="flex items-center justify-between">
                  <button
                    onClick={() => {
                      if (sections[activeIndex].brand === "Lean Retail") navigate("/retail");
                      if (sections[activeIndex].brand === "Lean Mobility") navigate("/mobility");
                      if (sections[activeIndex].brand === "Lean Industry") navigate("/industry");
                    }}
